...
ALTER TABLE user_preferences
    ...
    ADD COLUMN IF NOT EXISTS detail_close_delay_min DOUBLE PRECISION NOT NULL DEFAULT 0,
    ADD COLUMN IF NOT EXISTS detail_close_delay_max DOUBLE PRECISION NOT NULL DEFAULT 0,
