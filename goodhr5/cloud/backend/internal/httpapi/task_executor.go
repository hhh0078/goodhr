...
请严格返回 JSON：
{"resume":{"candidate_name":"张女士","birth_ym":"1998-01","phone":"","email":"","work_region":"德阳·旌阳区","work_years":"6年","expected_salary_min":5000,"expected_salary_max":8000,"basic_info":"26岁丨本科丨6年丨离职-随时到岗","education_level":"本科","expected_position":"课程顾问","online_status":"刚刚活跃","personal_description":"有课程销售经验，沟通跟进能力较好。","work_status":"离职-随时到岗","raw_text":"图片中识别到的完整简历文字","filter_text":"本科，6年，课程销售经验，期望德阳课程顾问。","work_experiences":[{"company_name":"成都某教育咨询有限公司","position_name":"课程顾问","content":"负责课程咨询、销售转化和学员跟进。","start_ym":"2024-03","end_ym":"2026-05"}],"educations":[{"school_name":"四川某大学","major_name":"市场营销","education_level":"本科","campus_experience":"","start_ym":"2018-09","end_ym":"2022-06"}],"certificates":[],"honors":[],"project_experiences":[],"colleague_communications":[],"resume_attachment_extracted_text":"图片中识别到的完整简历文字","ext":{}},"analysis":{"score":85,"reason":"销售经验匹配","should_greet":true}}`
