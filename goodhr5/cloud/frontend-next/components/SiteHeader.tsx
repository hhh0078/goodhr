      ...
      <Container maxWidth='lg'>
        ...
        >
          ...
          <Stack direction='row' spacing={2} sx={{ display: { xs: "none", lg: "flex" }, alignItems: "center" }}>
            <PublicStats compact />
            <Button component={Link} href='/login' variant='contained' sx={{ px: 2.5, borderRadius: "999px" }}>
              进入控制台
            </Button>
          </Stack>
          <Button
            ...
            href='/login'
            variant='contained'
            sx={{ display: { xs: "none", md: "inline-flex", lg: "none" }, px: 2.5, borderRadius: "999px" }}
          >
            进入控制台
          </Button>
          <IconButton
