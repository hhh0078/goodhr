// Package zhaopin 文件作用：实现智联登录页、推荐页、消息页和页面初始化。
package zhaopin
...
// InitializeLoginPage 执行智联招聘登录页配置的初始化动作。
...
// InitializeGreetingPage 关闭智联推荐页可选弹框。
...
// InitializeMessagesPage 关闭智联消息页可选提示。
