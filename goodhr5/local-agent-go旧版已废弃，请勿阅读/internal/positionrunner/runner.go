...
const unifiedAITimeout = time.Duration(localai.DefaultRequestTimeoutSeconds) * time.Second
const candidateTotalTimeout = unifiedAITimeout
const aiPrecheckTimeout = unifiedAITimeout
const detailFetchTimeout = 60 * time.Second
const ocrRecognizeTimeout = 60 * time.Second
const aiDetailTimeout = unifiedAITimeout
const aiScoreTimeout = unifiedAITimeout
...
const pendingAIVisionOutputTimeout = unifiedAITimeout
